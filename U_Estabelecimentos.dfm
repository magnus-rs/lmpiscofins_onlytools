object FRM_Estabelecimentos: TFRM_Estabelecimentos
  Left = 0
  Top = 0
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'Descricao'
          Title.Caption = 'Descri'#231#227'o / Apelido'
          Width = 325
          Visible = True
        end>
    end
  ...
  object Panel2: TPanel
    ...
    object Panel3: TPanel
      ...
      object Label1: TLabel
        ...
        Width = 91
        Height = 13
        Caption = 'Descri'#231#227'o / Apelido'
  ...
  object FDQ_Estab: TFDQuery
    ...
    Left = 624
    Top = 32
    object FDQ_EstabChave: TFDAutoIncField
      FieldName = 'Chave'
      Origin = 'Chave'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object FDQ_EstabCNPJ: TStringField
      FieldName = 'CNPJ'
      Origin = 'CNPJ'
      Required = True
    ...
    object FDQ_EstabRazao_Social: TStringField
      FieldName = 'Razao_Social'
      Origin = 'Razao_Social'
      Required = True
      Size = 100
    end
    object FDQ_EstabDescricao: TStringField
      FieldName = 'Descricao'
      Origin = 'Descricao'
      Required = True
      Size = 100
  ...
  object FDT_Estab: TFDTable
    Active = True
    IndexFieldNames = 'chave'
    Connection = DataModule1.FDConnection1
    TableName = 'lmpiscofinsdba.dbo.estabelecimentos'
    Left = 632
    Top = 169
    object FDT_Estabchave: TIntegerField
    ...
    object FDT_Estabdescricao: TStringField
      DisplayLabel = 'Descri'#231#227'o / Apelido'
      FieldName = 'descricao'
      Origin = 'descricao'
      Required = True
      Size = 100
    end
    object FDT_Estabcnpj: TStringField
      DisplayLabel = 'CNPJ'
      FieldName = 'cnpj'
      Origin = 'cnpj'
      Required = True
    ...
    object FDT_Estabrazao_social: TStringField
