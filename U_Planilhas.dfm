object FRM_Planilhas: TFRM_Planilhas
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Cadastro de FRM_Planilhas'
  ClientHeight = 216
  ClientWidth = 751
  Color = clBtnFace
  ...
  object DS1: TDataSource
    DataSet = FDQ_Planilha
    Left = 680
    Top = 33
  end
  object FDQ_Planilha: TFDQuery
    Active = True
    ...
    Left = 624
    Top = 32
    object FDQ_PlanilhaChave: TFDAutoIncField
      FieldName = 'Chave'
      Origin = 'Chave'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object FDQ_PlanilhaMes_Ref: TStringField
      Alignment = taCenter
      FieldName = 'Mes_Ref'
      Origin = 'Mes_Ref'
      Required = True
  ...
  object FDT_Planilha: TFDTable
    ...
    Left = 632
    Top = 169
    object FDT_PlanilhaChave: TFDAutoIncField
      FieldName = 'Chave'
      Origin = 'Chave'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object FDT_PlanilhaMes_Ref: TStringField
      Alignment = taCenter
      DisplayLabel = 'M'#234's de Refer'#234'ncia'
      FieldName = 'Mes_Ref'
      Origin = 'Mes_Ref'
      Required = True
      EditMask = '99\/9999;0;_'
